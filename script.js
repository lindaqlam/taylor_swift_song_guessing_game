...
// 	{
// 		lyric: 'I look through the windows of this love, even though we boarded them up',
...
// 	{
// 		lyric: 'We see you over there on the internet comparing all the girls who are killing it',
...
// 	{
// 		lyric: "I wounded the good and I trusted the wicked. Clearin' the air, I breathed in the smoke",
// 		song: 'Daylight'
// 	},
// 	{ lyric: "I once believed love would be black and white but it's golden", song: 'Daylight' },

// 	{
// 		lyric: 'Me, I was a robber first time that he saw me. Stealing hearts and running off and never saying sorry',
// 		song: '...Ready for It?'
// 	},
...
// 	{
// 		lyric: 'You should think about the consequence of your magnetic field being a little too strong',
// 		song: 'Gorgeous'
// 	},
// 	{ lyric: "You should take it as a compliment that I'm talking to everyone here but you", song: 'Gorgeous' },
// 	{
// 		lyric: "If you've got a girlfriend, I'm jealous of her. But if you're single that's honestly worse",
// 		song: 'Gorgeous'
// 	},
...
// 	{
// 		lyric: 'Put the money in a bag and I stole the keys. That was the last time you ever saw me',
// 		song: 'Getaway Car'
// 	},
...
// 	{
// 		lyric: "I'd kiss you as the lights went out, swaying as the room burned down",
...
// 	{
// 		lyric: "Did you think I wouldn't hear all the things you said about me?",
// 		song: "This Is Why We Can't Have Nice Things"
// 	},
// 	{
// 		lyric: "Here's a toast to my real friends. They don't care about that he said, she said",
// 		song: "This Is Why We Can't Have Nice Things"
// 	},
...
// 	{
// 		lyric: "My baby's fly like a jet stream, high above the whole scene, loves me like I'm brand new",
...
// 	{
// 		lyric: "Holdin' my breath, slowly I said, 'You don't need to save me, but would you run away with me?'",
// 		song: 'Call It What You Want'
// 	},
// 	{
// 		lyric: "You squeeze my hand three times in the back of the taxi, I can tell that it's going to be a long road",
// 		song: "New Year's Day"
// 	},
...
// 	{
// 		lyric: "You think I'm gonna hate you now 'cause you still don't know what I never said",
...
// 	{
// 		lyric: 'But there were strangers watching, and whispers turned to talking, and talking turned to screams',
// 		song: 'Wonderland'
// 	},
...
// 	{
// 		lyric: 'You call me up again just to break me like a promise. So casually cruel in the name of being honest',
// 		song: 'All Too Well'
// 	},
...
// 	{
// 		lyric: "I bet it never ever occurred to you that I can't say 'Hello' to you and risk another goodbye",
// 		song: 'I Almost Do'
// 	},
// 	{
// 		lyric: "We hadn't seen each other in a month when you said you needed space (what?)",
...
// 	},
// 	{
// 		lyric: "You would hide away and find your peace of mind with some indie record that's much cooler than mine",
// 		song: 'We Are Never Ever Getting Back Together'
// 	},
...
// 	{
// 		lyric: "Find myself at your door just like all those times before. I'm not sure how I got there.",
// 		song: 'The Last Time'
// 	},
...
// 	{
// 		lyric: "I've been spending the last eight months thinking all love ever does is break and burn and end",
// 		song: 'Begin Again'
// 	},
...
// 	{
// 		lyric: "I used to know my place was a spot next to you, now I'm searching the room for an empty seat",
...
// 	{
// 		lyric: "The battle's in your hands now but I would lay my armor down if you'd say you'd rather love than fight",
// 		song: 'The Story Of Us'
// 	},
...
// 	{
// 		lyric: "Please don't be in love with someone else. Please don't have somebody waiting on you",
// 		song: 'Enchanted'
// 	},
...
// 	{
// 		lyric: 'If you have children someday, when they point to the pictures, please tell them my name',
// 		song: 'Long Live'
// 	},
...
// 	{
// 		lyric: 'Ghosts from your past gonna jump out at me, lurking in the shadows with their lip gloss smiles,',
// 		song: 'Ours'
// 	},
// 	{ lyric: 'Your hands are tough but they are where mine belong in', song: 'Ours' },
// 	{
// 		lyric: 'Last night I heard my own heart beating, sounded like footsteps on my stairs',
// 		song: 'If This Was a Movie'
// 	},
// 	{ lyric: "It's not the kind of ending you wanna see now", song: 'If This Was a Movie' },
// 	{
// 		lyric: "Six months gone and I'm still reaching even though I know you're not there",
// 		song: 'If This Was a Movie'
// 	},
...
// 	{
// 		lyric: "Stand outside my window throwing pebbles screaming, 'I'm in love with you'",
...
// 	{
// 		lyric: 'Back then I swore I was gonna marry him someday, but I realized some bigger dreams of mine',
// 		song: 'Fifteen'
// 	},
...
// 	{
// 		lyric: "The way you walk, way you talk, way you say my name. It's beautiful, wonderful, don't you ever change",
// 		song: 'Hey Stephen'
// 	},
...
// 	{
// 		lyric: "Music starts playin' like the end of a sad movie. It's the kinda ending you don't really wanna see",
// 		song: 'Breathe'
// 	},
...
// 	{
// 		lyric: "So here's to everything coming down to nothing. Here's to silence, that cuts me to the core",
// 		song: 'Forever & Always'
// 	},
// 	{
// 		lyric: "I don't know why all the trees change in the fall. But I know you're not scared of anything at all",
// 		song: 'The Best Day'
// 	},
...
// 	},
// 	{
// 		lyric: "September saw a month of tears and thankin' God that you weren't here to see me like that",
// 		song: 'Tim McGraw'
// 	},
// 	{
// 		lyric:
...
// 	{
// 		lyric: "I guess it's true that love was all you wanted, 'cause you're givin' it away like it's extra change",
// 		song: 'Tied Together With a Smile'
// 	},
// 	{
// 		lyric: 'Hoping it will end up in his pocket, but he leaves you out like a penny in the rain',
// 		song: 'Tied Together With a Smile'
// 	},
// 	{
// 		lyric: "When you find everything you've looked for, I hope your love leads you back to my door",
// 		song: 'Stay Beautiful'
// 	},
...
// 	{
// 		lyric: "I should've been there, in the back of your mind. I shouldn't be asking myself why",
// 		song: "Should've Said No"
// 	},
// 	{ lyric: "You should've said no, baby and you might still have me", song: "Should've Said No" },
// 	{
// 		lyric: 'Take me back when our world was one block wide. I dared you to kiss me, and ran when you tried',
// 		song: "Mary's Song"
// 	},
// 	{
// 		lyric: "Our daddies used to joke about the two of us. They never believed we'd really fall in love",
// 		song: "Mary's Song"
// 	},
// 	{ lyric: "He's got a one-hand feel on the steering wheel, the other on my heart,", song: 'Our Song' },
// 	{
// 		lyric: "When we're on the phone and you talk real slow, 'cause it's late and your mama don't know,",
// 		song: 'Our Song'
// 	},
// 	{ lyric: 'You and I are painting pictures in the sky', song: "I'm Only Me When I'm With You" },
// 	{
// 		lyric: "I'm only up when you're not down, don't wanna fly if you're still on the ground",
// 		song: "I'm Only Me When I'm With You"
// 	},
// 	{ lyric: 'All I think about is how to make you think of me', song: 'Invisible' },
// 	{
// 		lyric: "Maybe I should've seen the signs, should've read the writing on the wall",
...
// 	{
// 		lyric: "I was trying to fly but I couldn't find wings. But you came along and you changed everything",
// 		song: 'Crazier'
// 	},
...
// 	{
// 		lyric: 'The way you roll your eyes, the way you taste. You make it hard for breathing',
